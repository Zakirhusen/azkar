...
const Download = () => {
  return (
    <div className="flex flex-col sm:flex-row sm:space-y-0 space-y-5 sm:space-x-5 mx-4 my-8">
      ...
      {/* https://d1.islamhouse.com/data/en/ih_books/single/en_Hisn_El_Muslim.pdf */}
      {/* https://d1.islamhouse.com/data/ur/ih_books/single2/ur_Hisnul_Muslim.pdf */}
      {/* https://d1.islamhouse.com/data/kn/ih_books/single/kn-translation-of-the-meanings-quran.pdf */}
      <div className="flex  justify-center">
        <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
          <h5 className="text-gray-900 text-xl leading-tight font-semibold mb-2">
            ಹಿಸ್ನುಲ್ ಮುಸ್ಲಿಮ್
          </h5>
          <p className="text-gray-700 text-base mb-4"> 
            Kannada hisnul muslim download in kannada language breif description
